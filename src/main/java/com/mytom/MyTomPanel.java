...
public class MyTomPanel extends JPanel implements Runnable,MouseListener {
	...
	public static void main(String[] args) throws Exception{
		System.out.println(MyTomPanel.class.getResource("").getPath());
		MyTomPanel.class.getResource("/img/Buttons/eat.png");
	 	BufferedImage btn_eat = ImageIO.read(MyTomPanel.class.getResource("/img/Buttons/eat.png"));
